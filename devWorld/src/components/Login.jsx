...
<div className="flex justify-center items-center my-10">
  ...
  <div className="card-body">
    <h2 className="card-title justify-center">Login</h2>
     ...
     {/* email */}
<div className='py-2'>
        <span className='label-text px-2'>Email Id</span>
      <label className="input validator w-full max-w-xs py-4">
  ...
  <input type="email"  onChange={(e)=>setEmail(e.target.value)} value={email} placeholder="mail@site.com"   className="py-4" required />
</label>
...
{/* password */}
<div className=''>
          <span className='label-text px-2'>Password</span>
